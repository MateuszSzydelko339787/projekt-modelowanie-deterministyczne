...
def create_plan():
    ...
    for i in range(8, 13):     # tu była zmiana
        tab[i][14] = 4
    for i in range(32, 34):
        tab[i][39] = 4
    for i in range(48, 54):     # tu była zmiana
        tab[i][40] = 4
    for i in range(1, 6):
        tab[i][53] = 4
    for j in range(19, 24):     # tu była zmiana
        tab[10][j] = 4
    for j in range(30, 36):     # tu była zmiana
        tab[23][j] = 4
    for j in range(13, 15):
        tab[28][j] = 4
    for j in range(13, 15):
        tab[36][j] = 4
    for j in range(9, 14):     # tu była zmiana
        tab[44][j] = 4
    for j in range(26, 30):     # tu była zmiana
        tab[44][j] = 4
